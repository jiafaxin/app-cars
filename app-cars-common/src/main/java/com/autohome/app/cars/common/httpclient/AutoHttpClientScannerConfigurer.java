 ...
 */
public class AutoHttpClientScannerConfigurer implements BeanDefinitionRegistryPostProcessor, ResourceLoaderAware, ApplicationContextAware {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        for (String packageName : basePackage) {
            Set<Class<?>> beanClazzs = scannerPackages(packageName);
            for (Class beanClazz : beanClazzs) {
                ...
                definition.setBeanClass(AutoHttpClientFactory.class);
            ...
            for (Resource resource : resources) {
                if (resource.isReadable()) {
                    ...
                    try {
                        ...
                        if(clazz.isAnnotationPresent(AutoHttpClient.class)) {
                            set.add(clazz);
                        }
