 ...
 * 0 15 0/1 * * ?
 */
@JobHander("SeriesClubTagJob")
@Service
public class SeriesClubCardTagJob extends IJobHandler {


    @Autowired
    SeriesClubCardTagComponent seriesClubTagComponent;
    ...
    public ReturnT<String> execute(String... strings) {
        ...
        seriesClubTagComponent.refreshAll(totalMinutes, x -> {
