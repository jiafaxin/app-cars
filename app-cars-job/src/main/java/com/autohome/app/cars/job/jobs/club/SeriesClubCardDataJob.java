 ...
 * 0 15 0/1 * * ?
 */
@JobHander("SeriesClubCardDataJob")
@Service
public class SeriesClubCardDataJob extends IJobHandler {


    @Autowired
    SeriesClubCardDataComponent seriesClubCardDataJob;
    ...
    public ReturnT<String> execute(String... strings) {
        ...
        seriesClubCardDataJob.refreshAll(totalMinutes, x -> {
