...
@Component
@Slf4j
public class RankSaleCityComponent extends RankBaseComponent<CityRankDataResultDto> {

    @Resource
    private RankCommonComponent rankCommonComponent;

    @Resource
    private RankSaleCitySourceComponent sourceComponent;
    ...
    private CityRankDataResultDto getDataFromDB(String beginMonth, String endMonth, Integer cityId, int size) {
        List<RankSaleCitySourceEntity> dataList = sourceComponent.getListByCondition(beginMonth, endMonth, cityId.toString(), size);
